      ...
      <div className="flex justify-center items-center py-[3rem]">
        <div className="bg-white border border-[#F1F1F1] rounded w-[90%] md:w-[80%] px-[1rem] md:px-[2rem] py-[2rem]">
          ...
          <div>
            ...
            <div className="flex justify-between items-center mt-8 mb-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <span className="Font-Inter text-[.8rem] text-gray-600">
                    Includes 50,000 Fee
                  </span>
                </div>
              </div>
            ...
            <div className="ml-8">
              <p className="font-Inter text-[.8rem] md:text-[.9rem] text-black">
                <span className="font-semibold">Requires:</span> National ID
                Card
              </p>
              <span className="font-Inter text-[.7rem] md:text-[.8rem] text-black">
                Details about this, details about this (Pending copy)
              </span>
            </div>
            <div>
              <hr className="my-8 mx-4 bg-[#F1F1F1]" />
          ...
          <div className="flex justify-between md:justify-end items-center mt-8 gap-4">
            <Link to="Payer-InformationParents" relative="path">
