    ...
    <div className="bg-herowave bg-cover bg-center bg-no-repeat md:px-[3rem] lg:px-[5rem] px-[1rem] py-[3rem] md:py-[5rem] flex flex-wrap md:flex-nowrap justify-between items-center gap-[1.5rem] lg:gap-[3rem]">
      <div className="md:w-[50%]">
        ...
        <div>
          ...
          <p className="font-Inter text-[.9rem] md:text-[1rem] text-gray-600">
            The preferred financial partner for students and institutions
            worldwide, fostering trust and seamless transactions for millions
            around the globe.
          </p>
        </div>
          ...
          <div className="flex justify-start items-center gap-2 mt-2">
            ...
            >
              ...
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M12.5 7.96166C12.5 7.31639 11.6208 7.12595 11.3538 7.71338L9.10908 12.6517C8.92851 13.049 9.21892 13.5 9.6553 13.5H11.5V16.0383C11.5 16.6836 12.3792 16.874 12.6462 16.2866L14.8909 11.3483C15.0715 10.951 14.7811 10.5 14.3447 10.5H12.5V7.96166ZM10.2765 12.5L11.5 9.8083V10.9C11.5 11.2314 11.7686 11.5 12.1 11.5H13.7235L12.5 14.1917V13.1C12.5 12.7686 12.2314 12.5 11.9 12.5H10.2765Z"
                fill="#1F39C4"
              />
            </svg>
            <p className="text-gray-500 font-Inter text-[.8rem]">
        ...
        <div>
          <form
            action=""
            className="flex-col md:flex-row justify-start items-center"
          >
            <input
              type="text"
              className="shadow appearance-none border w-full md:w-[60%] mb-4 md:mb-0 rounded-l px-[1.2rem] py-[.8rem] font-Inter text-[1rem] text-gray-700 leading-tight focus:border-secondary-0 focus:outline-none focus:shadow-outline"
              id="Institution"
              placeholder="Email"
            />
