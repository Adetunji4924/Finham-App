    ...
    <div className="bg-footer bg-cover bg-center bg-no-repeat py-[4rem] px-[1rem] md:px-[3rem]">
      <div className="flex flex-wrap md:flex-nowrap justify-between border-b-2 border-[#EAECF0] pb-[3rem]">
        ...
        <div className="mt-10 md:mt-0">
          <h1 className="text-white font-semibold font-Inter mb-4">
            Quik Links
          </h1>
          <ul className="flex flex-col gap-2">
            ...
            <li className="font-Inter text-[1rem] text-white">
      ...
      <div>
        <p className="mt-6 font-Inter text-gray-200">
          &copy; {currentYear} Finham. All Rights Reserved
        </p>
      </div>
    </div>
  );
